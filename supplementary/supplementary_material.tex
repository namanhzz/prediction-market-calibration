...
\end{tabular}
\begin{flushleft}
\small\textit{Note:} The extreme Polymarket slopes (e.g., 1.728 at 3--6h, 2.507 at 24--48h) reflect very thin markets. Finance is excluded from main comparison figures and tables.
\end{flushleft}
\end{table}
